    ...
    <p class="pagina__descripcion">Elige hasta 5 eventos para asistir en la forma presencial</p>
    ...
    <div class="eventos-registro">
        <main class="eventos-registro__listado">
            ...
            <p class="eventos-registro__fecha">Miercoles 7 de Octubre</p>   
            <div class="eventos-registro__grid">
            ...
            <p class="eventos-registro__fecha">Viernes 9 de Octubre</p>   
            <div class="eventos-registro__grid">
