...
?>
<!--Resumen del evento-->
<section <?php aos_animacion();?> class="resumen">
...
<<section class="speakers">
    ...
    <p class="speakers__descripcion">Conoce a los mejores Expertos de DevWebCamp</p>

    <!--Iteramos cada speaker-->
...
<section class="entradas">
    ...
    <div class="entradas__grid">
        ...
        <div class="entrada entrada--gratis">
            <h4 class="entrada__logo">&#60;DevWebCamp /></h4>
            <p class="entrada__plan">Gratis</p>
            <p class="entrada__precio">Gratis - 0$</p>
        </div>
    </div>
