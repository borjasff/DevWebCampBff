        ...
        <tbody class="table__tbody">
            <?php foreach($eventos as $evento) {?>
                <tr class="table__tr">
                    ...
                    <!--necesitamos cruzar información para reflejar la categoría no un 1 o un 2-->
                    <td class="table__td">
                        <?php echo $evento->categoria->nombre; ?></td>
                    <td class="table__td">
                        <?php echo $evento->dia->nombre . ', '. $evento->hora->hora; ?></td>
                    <td class="table__td">
                        <?php echo $evento->ponente->nombre . ' '. $evento->ponente->apellido; ?></td>
